...
const Form = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSubmitted(true);
      localStorage.clear();
      setSuccessMessage('Thank You for connecting Sweepsage! Our team will contact you soon.');
    } catch (error) {
  ...
  return (
    <div className="bg-black text-gray-200 px-8 py-12">
      {submitted ? (
        <div className="flex flex-col items-center justify-center bg-black text-gray-100 min-h-screen">
        <h2 className="text-2xl font-semibold mb-4 text-center">{successMessage}</h2>
        <button
          className="bg-indigo-500 text-gray-100 p-3 rounded-lg mt-4"
          onClick={() => router.back()}
        >
          Go Back
        </button>
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex items-center justify-center ">
            <a href="#" className="flex items-center">
              <img src="logo1.png" className="md:h-20 mr-3 h-12" alt="Sweepsage Logo" />
              <span className="self-center text-xl font-semibold" style={{ fontSize: '3rem' }}>
                Sweepsage
              </span>
            </a>
          </div>

          <div className="max-w-screen-xl mt-12 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-900 text-gray-900 rounded-lg shadow-lg">
              ...
              <div className="mt-8 text-center">
                <svg className="w-full" xmlns="http://www.w3.org/2000/svg" 
                  ...
                  <path
                    ...
                    transform="translate(-52 -162.63)" fill="#667eea" />
                  <path
                    d="M300.82,452.69a100,100,0,1,0,99.95,99.95A100,100,0,0,0,300.82,452.69Zm0,186.62a86.67,86.67,0,1,1,86.67-86.67A86.67,86.67,0,0,1,300.82,639.31Z"
                    transform="translate(-52 -162.63)" opacity="0.1" />
                  ...
                  <path
                    d="M802.9,300.14c-1.94,1.85-2.26,4.78-2.46,7.45l-.3,3.91a19.72,19.72,0,0,0-.07,3.17c0,.65.16,1.31.22,2s.08,1.56.09,2.35l0,5.78a6.82,6.82,0,0,0,.64,3.47,2.36,2.36,0,0,0,3,1.08,3.42,3.42,0,0,0,1.24-1.92,29.85,29.85,0,0,0,2-7.32c.08-.87.09-1.74.17-2.61s.23-1.78.36-2.66c.56-3.68.81-7.4,1.06-11.11.07-1.1,1.06-5.43-.38-5.91-.7-.23-2.15.49-2.82.73A7.94,7.94,0,0,0,802.9,300.14Z"
                    transform="translate(-52 -162.63)" fill="#be6f72" />
                  <path
                    d="M802.9,300.14c-1.94,1.85-2.26,4.78-2.46,7.45l-.3,3.91a19.72,19.72,0,0,0-.07,3.17c0,.65.16,1.31.22,2s.08,1.56.09,2.35l0,5.78a6.82,6.82,0,0,0,.64,3.47,2.36,2.36,0,0,0,3,1.08,3.42,3.42,0,0,0,1.24-1.92,29.85,29.85,0,0,0,2-7.32c.08-.87.09-1.74.17-2.61s.23-1.78.36-2.66c.56-3.68.81-7.4,1.06-11.11.07-1.1,1.06-5.43-.38-5.91-.7-.23-2.15.49-2.82.73A7.94,7.94,0,0,0,802.9,300.14Z"
                    transform="translate(-52 -162.63)" opacity="0.1" />
            ...
            <div>
              ...
              <div className="mt-8">
                <span className="uppercase text-sm text-gray-300 font-bold">Mobile Number</span>
                <input 
                  name="Pnumber" 
                  className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                  type="number" 
