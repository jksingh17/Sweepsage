...
const Stat: React.FC = () => {
  return (
    <section className="flex flex-col w-10/12 mx-auto">
      ...
      <div className="mt-10 grid grid-cols-2 lg:grid-cols-4  md:gap-y-4 place-items-center w-full mx-auto max-w-7xl md:px-5">
        
        {/* Card 1 - Expert Chat & Call Minutes */}
        <div className="flex flex-col justify-center items-center bg-gray-900 px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-tr-none rounded-tl-xl rounded-bl-none rounded-br-none md:rounded-xl">
          ...
          <p className="font-medium text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center text-white">
            Projects Completed
          </p>
        </div>

        {/* Card 2 - Average Expert Rating */}
        <div className="flex flex-col justify-center items-center bg-gray-900 px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-tr-xl rounded-tl-none rounded-bl-none rounded-br-none md:rounded-xl">
          <div className="flex flex-row justify-center items-center">
            <svg
              className="w-[35px] h-[35px] md:w-[50px] md:h-[50px]"
              viewBox="0 0 51 50"
        ...
        <div className="flex flex-col justify-center items-center bg-gray-900 px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-tr-none rounded-tl-none rounded-bl-xl rounded-br-none md:rounded-xl">
        <div className="flex flex-row justify-center items-center"> 
        ...
        <div className="flex flex-col justify-center items-center bg-gray-900 px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-tr-none  rounded-tl-none rounded-bl-none rounded-br-xl md:rounded-xl">
        <div className="flex flex-row justify-center items-center">      
