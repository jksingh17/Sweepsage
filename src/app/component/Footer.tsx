...
const Footer: React.FC = () => {
  ...
  const handleServiceClick = (serviceName: string) => {
   ...
   window.open("https://wa.me/9555826615", "_blank");
  };
  return (
    <footer>
      <div className="bg-gray-900 py-4 text-gray-400 hover:cursor-pointer">
        <div className="container px-4 mx-auto">
          <div className=" flex flex-wrap justify-between">
            ...
            alt="Landwind Logo"
            />
            <span className="self-center text-3xl whitespace-nowrap text-white font-light italic">
            Sweepsage
            </span>
            </a><br />
           ...
           <div className="px-4 my-4 w-full sm:w-auto">
              ...
              <ul className="leading-8">
                <li><a  className="hover:text-blue-400 hover:cursor-pointer">About Us</a></li>
                <li><a  className="hover:text-blue-400 hover:cursor-pointer">Terms &amp; Conditions</a></li>
                <li><a  className="hover:text-blue-400 hover:cursor-pointer">Privacy Policy</a></li>
                <li><a onClick={() => window.open("https://wa.me/9555826615", "_blank")} className="hover:text-blue-400 hover:cursor-pointer">Contact Us</a></li>
              </ul>
            </div>
  ...
  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-1 leading-8">
    <li>
      <a onClick={() => handleServiceClick('Ad Creation')} className="hover:text-blue-400 hover:cursor-pointer">Commercial </a>
    </li>
    <li>
      <a onClick={() => handleServiceClick('Photography')}  className="hover:text-blue-400 hover:cursor-pointer">wedding</a>
    </li>
    <li>
      <a onClick={() => handleServiceClick('Social Media Management')} className="hover:text-blue-400 hover:cursor-pointer">Pre wedding</a>
    </li>
    <li>
      <a onClick={() => handleServiceClick('Video Editing')} className="hover:text-blue-400 hover:cursor-pointer">Destination wedding</a>
    </li>
    <li>
      <a onClick={() => handleServiceClick('Gaming ID vendors')} className="hover:text-blue-400 hover:cursor-pointer">Birthday celebration</a>
    </li>
    
    <li>
      <a onClick={() => handleServiceClick('Web Development')} className="hover:text-blue-400 hover:cursor-pointer">Web Development/App Development</a>
    </li>
            ...
            <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
              <div>
                ...
                <div>
                  <a className="inline-flex items-center justify-center h-8 w-8 ml-4  hover:text-blue-400  hover:border-blue-400 hover:cursor-pointer" href='https://www.instagram.com/sweepsage_/'>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" className='w-7 h-7' width="28" height="28" viewBox="0 0 51 51" fill="none">
        ...
        <defs>
          ...
          <radialGradient id="paint1_radial_7092_54379" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(31.1086 53.257) scale(51.4733 51.4424)">
            ...
            <stop offset="1" stop-color="#8C3AAA"/>
                  ...
                  <a className="inline-flex items-center justify-center h-8 w-8 ml-4  hover:text-blue-400  hover:border-blue-400 hover:cursor-pointer">
                  <button className=" flex items-center justify-center bg-gradient-to-tr from-red-50 to-pink-50 cursor-pointer rounded-md shadow-md shadow-transparent transition-all duration-300 hover:shadow-red-200" >
                  <svg className="h-7 w-7"  xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 93 92" fill="none">
      ...
      <path d="M50.7568 42.1716L69.3704 21H64.9596L48.7974 39.383L35.8887 21H21L40.5205 48.7983L21 71H25.4111L42.4788 51.5869L56.1113 71H71L50.7557 42.1716H50.7568ZM44.7152 49.0433L42.7374 46.2752L27.0005 24.2492H33.7756L46.4755 42.0249L48.4533 44.7929L64.9617 67.8986H58.1865L44.7152 49.0443V49.0433Z" fill="black"/>
                  ...
                  <a className="inline-flex items-center justify-center h-8 w-8 ml-4 hover:text-blue-400  hover:border-blue-400 hover:cursor-pointer">
                  <button className=" flex items-center justify-center bg-gradient-to-tr from-red-50 to-pink-50 cursor-pointer rounded-md shadow-md shadow-transparent transition-all duration-300 hover:shadow-red-200" >
                  <svg className="h-7 w-7" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 92 93" fill="none">
        ...
        <div className="container mx-auto px-4">
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="px-4 w-full text-center sm:w-auto sm:text-left">
              Copyright © {new Date().getFullYear()} Sweepsage. All rights reserved.
            </div>
